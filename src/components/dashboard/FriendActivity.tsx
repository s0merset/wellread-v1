    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 overflow-x-auto pb-4">
        {activities.map((activity, index) => (
          <div
            key={index}
            className="rounded-xl border border-surface-highlight bg-card p-4 hover:shadow-lg transition-shadow w-80 h-64 flex-shrink-0 flex flex-col"
          >
              ...
              <div className="flex-1 min-w-0 flex flex-col">
                ...
                <div className="flex-1 overflow-auto">
                  {activity.type !== "list" && activity.book && (
                    <div className="mt-3 p-3 rounded-lg bg-surface-highlight/50">
